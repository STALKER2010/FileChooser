...
public class FileUtils {
	 ...
	 * @return
	 */
	public static boolean isVideo(Context con,String filename) {
		String mimeType = getMimeType(con,new File(filename));
	...
	public static boolean isLocal(String uri) {
		if (uri != null && !uri.startsWith("http://") && !uri.startsWith("ftp://") && !uri.startsWith("rtsp://") && !uri.startsWith("https://")) {
			return true;
		}
		return false;
	}
